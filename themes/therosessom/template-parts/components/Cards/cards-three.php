...
<section class="cards-three bg-primary-light py-16 lg:py-[92px] z-20 relative">
    <div class="max-w-[80%] lg:container-md mx-auto px-4 flex flex-col">
        ...
        <div class="mb-12 flex flex-col lg:flex-row items-center justify-center lg:justify-start text-center font-serif">
            <?php if ($title) : ?>
                <span class="text-2xl text-gray-800 capitalize italic font-primary"><?php echo esc_html($title); ?></span>
            <?php endif; ?>

            
            <?php if ($subtitle) : ?>
                <span class="text-gray-400 mx-4 hidden lg:inline">/</span>
                <span class="mt-2 md:mt-0 text-sm font-primary text-gray-500 uppercase tracking-widest">
        ...
        <?php if ($blurb) : ?>
            <div class="font-primary prose prose-lg mx-auto lg:mr-0 lg:ml-auto justify-end text-gray-700 mb-10">
                <?php echo $blurb; ?>
            </div>
        <?php endif; ?>
