<div id="primary" class="site-main single-portfolio">
    <?php
    while ( have_posts() ) :
        the_post();
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16'); ?>>
        ...
        <div class="max-w-[100%] lg:max-w-[80%] lg:container-lg mx-auto px-4 flex flex-col py-16">
            ...
            <div class="flex flex-col md:flex-row md:gap-x-12 lg:gap-x-20 items-stretch min-h-[500px]">
                ...
                <div class="w-full mb-8 md:mb-0 md:basis-[57%]">
                    <?php if ( $two_images ) : ?>
                        <div class="flex gap-4 mb-6 items-stretch">
                            <?php foreach( $two_images as $item ) : 
                                ...
                                if( $image ): ?>
                                    <div class="w-1/2" data-aos="fade-in" data-aos-duration="600" data-aos-delay="350">
                                        <?php if( !empty($image_link) ): ?>
                                            <a href="<?php echo esc_url($image_link); ?>" target="_blank" rel="noopener noreferrer" class="block w-full h-full">
                                                <img src="<?php echo esc_url($image['sizes']['medium']); ?>" 
                                                     alt="<?php echo esc_attr($image_alt); ?>" 
                                                     class="w-full h-full aspect-square object-cover hover:opacity-90 transition-opacity duration-300">
                                            </a>
                                        <?php else: ?>
                                            <img src="<?php echo esc_url($image['sizes']['medium']); ?>" 
                                                 alt="<?php echo esc_attr($image_alt); ?>" 
                    ...
                    <div>
                        ...
                        <div class="entry-content font-secondary font-light md:mt-[5rem]" data-aos="fade-in" data-aos-duration="600" data-aos-delay="650">
                            <?php the_content(); ?>
                        </div>
                    </div>
                </div>

                <div class="md:basis-[43%]" data-aos="fade-in" data-aos-duration="600">
        ...
        <?php endif;?> 
            ...
            <?php if ( $slider_images ) : ?>
                <div class="max-w-[95%] md:max-w-[70%] mx-auto">
                    <div class="relative portfolio-swiper-container mb-8">
                        <div class="main-portfolio-swiper swiper h-[70vh]">
                                ...
                                <?php foreach ( $slider_images as $slide ) : 
                                    ...
                                    <div class="swiper-slide flex items-center justify-center">
                                        <?php if( !empty($slider_large_image_link) ): ?>
                                            <a href="<?php echo esc_url($slider_large_image_link); ?>" target="_blank" rel="noopener noreferrer">
                                                <img src="<?php echo esc_url($image['sizes']['large']); ?>" 
                                                     alt="<?php echo esc_attr(isset($image['alt']) ? $image['alt'] : ''); ?>" 
                                                     class="w-auto h-auto max-w-full max-h-full hover:opacity-90 transition-opacity duration-300">
                                            </a>
                                        <?php else: ?>
                                            <img src="<?php echo esc_url($image['sizes']['large']); ?>" 
                                                 alt="<?php echo esc_attr(isset($image['alt']) ? $image['alt'] : ''); ?>" 
                    ...
                    ?>
                        <div class="pt-4 flex justify-end mt-4" data-aos="fade-up">
    ...
    <nav class="portfolio-navigation flex justify-between max-w-6xl mx-auto lg:max-w-[1024px] px-4 sm:px-6 lg:px-16 pb-8">
